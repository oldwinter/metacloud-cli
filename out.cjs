  ...
  "node_modules/prompts/dist/elements/text.js"(exports, module2) {
    ...
    var TextPrompt = class extends Prompt {
      ...
      render() {
        ...
        if (!this.firstRender) {
          if (this.outputError)
            this.out.write(cursor.down(lines(this.outputError, this.out.columns) - 1) + clear2(this.outputError, this.out.columns));
...
` : "") + `    enter/return: Complete answer`;
      ...
      render() {
        ...
        this.clear = clear2(prompt, this.out.columns);
      }
    };
...
var require_text2 = __commonJS({
  "node_modules/prompts/lib/elements/text.js"(exports, module2) {
    ...
    var { erase, cursor } = require_src();
    var { style, clear: clear2, lines, figures } = require_util2();
    var TextPrompt = class extends Prompt {
      constructor(opts = {}) {
        super(opts);
        this.transform = style.render(opts.style);
...
var require_select2 = __commonJS({
  "node_modules/prompts/lib/elements/select.js"(exports, module2) {
    ...
    var color = require_kleur();
    var Prompt = require_prompt2();
    var { style, clear: clear2, figures, wrap, entriesToDisplay } = require_util2();
...
var require_toggle2 = __commonJS({
  "node_modules/prompts/lib/elements/toggle.js"(exports, module2) {
    var color = require_kleur();
    var Prompt = require_prompt2();
    var { style, clear: clear2 } = require_util2();
...
var require_date2 = __commonJS({
  "node_modules/prompts/lib/elements/date.js"(exports, module2) {
    ...
    var color = require_kleur();
    var Prompt = require_prompt2();
    var { style, clear: clear2, figures } = require_util2();
    var { erase, cursor } = require_src();
...
var require_number2 = __commonJS({
  "node_modules/prompts/lib/elements/number.js"(exports, module2) {
    ...
    var Prompt = require_prompt2();
    var { cursor, erase } = require_src();
    var { style, figures, clear: clear2, lines } = require_util2();
    var isNumber = /[0-9]/;
    var isDef = (any) => any !== void 0;
    var round = (number, precision) => {
      let factor = Math.pow(10, precision);
...
var require_multiselect2 = __commonJS({
  "node_modules/prompts/lib/elements/multiselect.js"(exports, module2) {
    ...
    var { cursor } = require_src();
    var Prompt = require_prompt2();
    var { clear: clear2, figures, style, wrap, entriesToDisplay } = require_util2();
    var MultiselectPrompt = class extends Prompt {
      constructor(opts = {}) {
        super(opts);
        this.msg = opts.message;
...
var require_autocompleteMultiselect2 = __commonJS({
  "node_modules/prompts/lib/elements/autocompleteMultiselect.js"(exports, module2) {
    ...
    var { clear: clear2, style, figures } = require_util2();
    var AutocompleteMultiselectPrompt = class extends MultiselectPrompt {
      constructor(opts = {}) {
        opts.overrideRender = true;
        super(opts);
...
var require_ansi_styles = __commonJS({
  "node_modules/ansi-styles/index.js"(exports, module2) {
    ...
    function assembleStyles3() {
      ...
      setLazyProperty(styles2.color, "ansi", () => makeDynamicStyles(wrapAnsi163, "ansi16", ansi2ansi, false));
      setLazyProperty(styles2.color, "ansi256", () => makeDynamicStyles(wrapAnsi2563, "ansi256", ansi2ansi, false));
      setLazyProperty(styles2.color, "ansi16m", () => makeDynamicStyles(wrapAnsi16m3, "rgb", rgb2rgb, false));
      setLazyProperty(styles2.bgColor, "ansi", () => makeDynamicStyles(wrapAnsi163, "ansi16", ansi2ansi, true));
      setLazyProperty(styles2.bgColor, "ansi256", () => makeDynamicStyles(wrapAnsi2563, "ansi256", ansi2ansi, true));
      setLazyProperty(styles2.bgColor, "ansi16m", () => makeDynamicStyles(wrapAnsi16m3, "rgb", rgb2rgb, true));
      return styles2;
    }
...
var require_util3 = __commonJS({
  "node_modules/ora/node_modules/chalk/source/util.js"(exports, module2) {
    "use strict";
...
var require_templates = __commonJS({
  "node_modules/ora/node_modules/chalk/source/templates.js"(exports, module2) {
    "use strict";
    ...
    function buildStyle(chalk4, styles2) {
      const enabled = {};
    ...
    module2.exports = (chalk4, temporary) => {
      ...
      temporary.replace(TEMPLATE_REGEX, (m, escapeCharacter, inverse, style, close, character) => {
        if (escapeCharacter) {
          ...
          chunk = [];
          chunks.push(styles2.length === 0 ? string : buildStyle(chalk4, styles2)(string));
          styles2.push({ inverse, styles: parseStyle(style) });
        } else if (close) {
          if (styles2.length === 0) {
            throw new Error("Found extraneous } in Chalk template literal");
          }
          chunks.push(buildStyle(chalk4, styles2)(chunk.join("")));
          chunk = [];
          styles2.pop();
        } else {
...
var require_source = __commonJS({
  "node_modules/ora/node_modules/chalk/source/index.js"(exports, module2) {
    "use strict";
...
var require_util4 = __commonJS({
  "node_modules/boxen/node_modules/chalk/source/util.js"(exports, module2) {
    "use strict";
    var stringReplaceAll2 = (string, substring, replacer) => {
      let index = string.indexOf(substring);
      if (index === -1) {
...
var require_templates2 = __commonJS({
  "node_modules/boxen/node_modules/chalk/source/templates.js"(exports, module2) {
    "use strict";
    var TEMPLATE_REGEX = /(?:\\(u(?:[a-f\d]{4}|\{[a-f\d]{1,6}\})|x[a-f\d]{2}|.))|(?:\{(~)?(\w+(?:\([^)]*\))?(?:\.\w+(?:\([^)]*\))?)*)(?:[ \t]|(?=\r?\n)))|(\})|((?:.|[\r\n\f])+?)/gi;
    var STYLE_REGEX = /(?:^|\.)(\w+)(?:\(([^)]*)\))?/g;
    var STRING_REGEX = /^(['"])((?:\\.|(?!\1)[^\\])*)\1$/;
...
var require_source2 = __commonJS({
  "node_modules/boxen/node_modules/chalk/source/index.js"(exports, module2) {
    "use strict";
    var ansiStyles3 = require_ansi_styles();
    var { stdout: stdoutColor2, stderr: stderrColor2 } = require_supports_color();
    var {
...
var require_clear3 = __commonJS({
  "node_modules/clear/index.js"(exports, module2) {
    var assert = require("assert");
    module2.exports = function clear2(opts) {
      ...
      assert(typeof opts.fullClear === "boolean", "opts.fullClear must be a boolean");
...
var Standard_default = `flf2a$ 6 5 16 15 13 0 24463 229
...
function stringWidth(string, options = {}) {
  ...
  for (let index = 0; index < string.length; index++) {
    ...
    const code = import_eastasianwidth.default.eastAsianWidth(string.charAt(index));
    switch (code) {
      case "F":
      case "W":
        width += 2;
...
var BORDERS_WIDTH = 2;
var terminalColumns = () => {
  const { env: env2, stdout, stderr } = import_node_process5.default;
...
var boxContent = (content, contentWidth, options) => {
  const colorizeBorder = (border) => {
    ...
    return options.dimBorder ? import_chalk3.default.dim(newBorder) : newBorder;
  };
...
var isColorValid = (color) => typeof color === "string" && (import_chalk3.default[color] || isHex(color));
var getColorFn = (color) => isHex(color) ? import_chalk3.default.hex(color) : import_chalk3.default[color];
var getBGColorFn = (color) => isHex(color) ? import_chalk3.default.bgHex(color) : import_chalk3.default[(0, import_camelcase.default)(["bg", color])];
...
// index.js
var import_clear = __toESM(require_clear3());
import_figlet.default.parseFont("Standard", Standard_default);
async function init() {
  async function banner() {
    import_figlet.default.text("METACLOUD ", {
      font: "Standard",
